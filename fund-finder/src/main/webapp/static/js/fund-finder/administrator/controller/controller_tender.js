...
.controller('Administrator_TenderOverviewCtrl', function($rootScope, $scope, $state, Administrator_TenderService) {
	$scope.gridOptions = {
		...
		$scope.showStatistics = function(entity) {
			$state.go('administrator.tender_statistics', { 'id' : entity.id });
		};
...
//	STATISTICS
// ==============================================================================================================
.controller('Administrator_TenderStatisticsCtrl', function($rootScope, $scope, $state, $stateParams, Administrator_ImpressionService) {
	$scope.id = $stateParams.id;
	...
	$scope.getImpressionStatistics = function(statisticsPeriod) {
		Administrator_ImpressionService.getImpressionStatistics("TENDER", $stateParams.id, (statisticsPeriod) ? statisticsPeriod : "LAST_7_DAYS")
			.success(function(data, status) {
