...
// 	OVERVIEW
// ==============================================================================================================
.controller('InvestmentOverviewCtrl', function($rootScope, $scope, $state, TotalService, InvestmentService) {
	$scope.gridOptions = {
    	...
    	$scope.getPage = function(page, size) {
			...
			InvestmentService.getPage(uiGridResource).
			...
			BootstrapDialog.show({
	            ...
	            buttons: [
					...
					},
	            	{
		                ...
		                action: function(dialog) {
		                	InvestmentService.deleteInvestment(entity.id)
...
// 	EDIT
// ==============================================================================================================
.controller('InvestmentEditCtrl', function($rootScope, $scope, $state, $stateParams, TotalService, InvestmentService) {
	...
	$scope.save = function() {
		InvestmentService.saveInvestment($scope.investment)
			.success(function(data, status) {
	...
	InvestmentService.getInvestment($stateParams.id)
		.success(function(data, status) {
			$scope.investment = data;
		})
		.error(function(data, status) {
